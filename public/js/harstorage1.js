...
HARSTORAGE.Timeline.prototype.get = function(label, mode) {
    ...
    var URI = "results/timeline?label=" + encodeURIComponent(label) + "&mode=" + mode;
...
//    this.spinner.style.display = "block";
    ...
    var set_data = function() {
        ...
        $("#J_Capture").attr("href", that.json.screen_path);
...
//        window.setInterval("HARSTORAGE.autoHeight()", 100);
    ...
    this.URI = "results/runinfo?timestamp=" + timestamp;
